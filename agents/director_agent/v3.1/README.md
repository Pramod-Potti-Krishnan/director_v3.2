...
- **Multi-Model Support**: Works with Google Gemini, OpenAI, and Anthropic models
...
- At least one AI service API key (Google, OpenAI, or Anthropic)

### Installation

1. **Clone or copy this directory**:
```bash
cd agents/director_agent
```
...
```bash
cp .env.example .env
# Edit .env and add your API keys and Supabase configuration
```
